...
tl.seed(1)
counter = 0
attenuation_values = [0.10, 0.15, 0.5]
...
@pytest.mark.parametrize("distance", range(1, 202, 10))
def test_3stage_protocol(setup_network, distance, attenuation):
    ...
    alice.protocols[0].end_of_round(distance * 18, num_rounds, attenuation)
    ...
    # Draw the network diagram
        diagram_file_name = f'network_diagram_3_stage.png'
